...
/***/ function(module, exports, __webpack_require__) {
	...
	var pp = _interopRequireWildcard(_file);
	...
	funcpp().then(function (v) {
	    return console.log(v, 22);
	}, function (e) {
	    return console.log(e, 55);
	}).catch(function (e) {
	    return console.log(e, 33);
	});
